...
class NPUSparseLIGradKlLossOpBuilder(MindSpeedOpBuilder):
    OP_NAME = "npu_sparse_lightning_indexer_grad_kl_loss"
    _torch_path = None

    def __init__(self):
        from sysconfig import get_paths
        self._torch_path = os.path.dirname(os.path.abspath(torch.__file__))
        super(NPUSparseLIGradKlLossOpBuilder, self).__init__(self.OP_NAME)

    def sources(self):
        return ['ops/csrc/cann/npu_sparse_lightning_indexer_grad_kl_loss.cpp']
